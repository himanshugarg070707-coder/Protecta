...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull MaterialCardView rootView, @NonNull Button btnDeleteContact,
      @NonNull Button btnEditContact, @NonNull TextView tvContactName,
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnEditContact = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemContactBinding((MaterialCardView) rootView, btnDeleteContact, btnEditContact,
